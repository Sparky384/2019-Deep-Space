...
public class Constants{
	...
	public static final double kDrive_P = 0.033;		// far away P gain - 0.060   From: 0.009
 	public static final double kDrive_Pa = 0.002;		// approach P gain - 0.08
 	public static final double kDrive_I = 0.0015;		// far away I gain
 	public static final double kDrive_Ia = 0.00015;		// approach I gain - 0.0005
	...
	public static final double kWrist_Pu = 0.025; 		// Proportional Gain, rotating upwards 		[0.030]
	public static final double kWrist_Iu = 0.0001;		// Integral Gain, rotating upwards 			[0.00003]
	public static final double kWrist_Du = 0.0; 		// Derivative Gain, rotating upwards		[0.00025]
	public static final double kWrist_FFu = 0.00042;	// Feed Forward Gain, rotating upwards 		[0.00042]
	
	public static final double kWrist_Pd = 0.01; 		// Proportional Gain, rotating downwards 	[0.01]
	public static final double kWrist_Id = 0.0;			// Integral Gain, rotating downwards		[0.0]
	public static final double kWrist_Dd = 0.0; 		// Derivative Gain, rotating downwards		[0.0]
	public static final double kWrist_FFd = 0.0; 		// Feed Forward Gain, rotating downwards	[0.0]
	...
	public static final double DRIVE_DIST_PER_PULSE = 5.875 * Math.PI / DRIVE_ENC_PPR;	// units are in inche
}
